...
<head>
    ...
    <meta charset="utf-8" />
    <title>Add Task | <?= $site["site_title"]?></title>
                            ...
                            <div class="card-body">
                                        ...
                                        <form class="custom-validation" id="form">
                                            ...
                                            <div class="mb-3 mt-5">
                                                <label>Task</label>
                                                <div>
                                                    <textarea data-parsley-type="number" type="text" class="form-control parsley-success" required="" placeholder="Enter task here" data-parsley-id="17" aria-describedby="parsley-id-17" name="task"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control parsley-success" list="assignuser" id="assignuserinput" name="assignuser">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <input type="date" class="form-control parsley-success" required="" placeholder="Enter players age" data-parsley-id="17" aria-describedby="parsley-id-17" name="duedate">
                                                </div>
                                            </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.trim() == 'success') {
                                $("#success-msg").html("Task successfully added. Loading...");
                                $("#success").fadeIn();
                                setTimeout(()=>{
